...
class Pro_estimate():
    ...
    def get_pro2(self, n, m):
        ...
        now_jiashe = np.log(self.x_array) * n + np.log(1 - self.x_array) * (m - n) + self.pro_x_array + np.log(
            self.step_x_array)  # 调整原始的经验分布
...
if __name__ == "__main__":
    b = Pro_estimate()
    print b.get_pro_r(0.01, 6, 1000)
    print b.get_pro_r(0.000001032,8, 21432)